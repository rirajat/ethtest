...
public class ShoppingTest {
	...
	public void getShopping() throws UnirestException {
		HttpResponse<JsonNode> jsonResponse = Unirest
				.get("http://localhost:" + this.randomServerPort + "/api/shopping/1")
	...
	public void getShopping_NoData() throws UnirestException {
		HttpResponse<JsonNode> jsonResponse = Unirest
				.get("http://localhost:" + this.randomServerPort + "/api/shopping/100")
				.header("accept", "application/json").asJson();
	...
	public void postShopping() throws UnirestException {
		...
		HttpResponse<String> jsonResponse = Unirest.post("http://localhost:" + this.randomServerPort + "/api/shopping/")
	...
	public void addLineItem() throws UnirestException {
		...
		HttpResponse<JsonNode> jsonResponse = Unirest
				.put("http://localhost:" + this.randomServerPort + "/api/shopping/1/item")
				.header("Content-Type", "application/json").body(req).asJson();
	...
	public void addLineItemWithNoCart() throws UnirestException {
		...
		HttpResponse<JsonNode> jsonResponse = Unirest
				.put("http://localhost:" + this.randomServerPort + "/api/shopping/40/item")
				.header("Content-Type", "application/json").body(req).asJson();
	...
	public void updateLineItem() throws UnirestException {
		...
		HttpResponse<JsonNode> jsonResponse = Unirest
				.patch("http://localhost:" + this.randomServerPort + "/api/shopping/2/item/1")
				.header("Content-Type", "application/json").body(req).asJson();
	...
	public void deleteLineItem() throws UnirestException {
		...
		HttpResponse<JsonNode> jsonResponse = Unirest
				.delete("http://localhost:" + this.randomServerPort + "/api/shopping/2/item/2")
	...
	public void deleteLineItemInWrongShoppingCart() throws UnirestException {
		...
		HttpResponse<JsonNode> jsonResponse = Unirest
				.delete("http://localhost:" + this.randomServerPort + "/api/shopping/1/item/2")
				.header("Content-Type", "application/json").asJson();
	...
	public void deleteInvalidLineItem() throws UnirestException {
		...
		HttpResponse<JsonNode> jsonResponse = Unirest
				.delete("http://localhost:" + this.randomServerPort + "/api/shopping/2/item/20")
				.header("Content-Type", "application/json").asJson();
	...
	public void submitOrder() throws UnirestException {
		...
		HttpResponse<String> jsonResponse = Unirest
				.post("http://localhost:" + this.randomServerPort + "/api/shopping/2/submit")
	...
	public void submitOrderForbiden() throws UnirestException {
		...
		HttpResponse<String> jsonResponse = Unirest
				.post("http://localhost:" + this.randomServerPort + "/api/shopping/22/submit")
				.header("Content-Type", "application/json").asString();
	...
	public void submitOrderWithNoItems() throws UnirestException {
		...
		HttpResponse<String> jsonResponse = Unirest
				.post("http://localhost:" + this.randomServerPort + "/api/shopping/1/submit")
				.header("Content-Type", "application/json").asString();
