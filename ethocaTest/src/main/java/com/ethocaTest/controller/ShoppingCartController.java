...
public class ShoppingCartController {
	...
	@GetMapping("/{id}")
	@ApiOperation(value = "Get shopping cart by shopping cart id.")
	...
	public void addToShoppingCart(@PathVariable int id, @RequestBody LineItemReq item) {
		shoppingCart.add(id, item);
	}

	@DeleteMapping("/{id}/item/{itemId}")
	@ApiOperation(value = "Delete an item from shopping cart.")
	public void deletItem(@PathVariable int id, @PathVariable int itemId) {
		shoppingCart.remove(id, itemId);
	}

	@PatchMapping("/{id}/item/{itemId}")
	@ApiOperation(value = "Update an item in shopping cart.")
	public void updateShoppingCart(@PathVariable int id, @PathVariable int itemId, @RequestBody LineItemReq item) {
		item.setId(itemId);
	...
	@ResponseStatus(HttpStatus.CREATED)
	@ApiOperation(value = "Submt an order.")
